...
public class SendEmail extends javax.swing.JFrame {
   ...
   if(open && fc.showOpenDialog(this) == fc.APPROVE_OPTION)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        jPasswordFrom.setText("srivatsa"); // Enter Your GmailApp Password
        jTextFrom.setText("shrivatsakulkarni6@gmail.com"); // Enter your gmail
    ...
    public boolean SendMail() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Waiting for Network Either"+ mex.getMessage());
        }
        return true;
    }
